...
bool parseWifiQR(String qr) {
  // Serial.println("running parsing");
  wifiType = "";
  wifiSSID = "";
  wifiPassword = "";
  wifiHidden = false;
  ...
  while (qr.length() > 0) {
    ...
    String pair = qr.substring(0, sep);
    qr = qr.substring(sep + 1);
    ...
    if (key == "T") wifiType = value;
    else if (key == "S") wifiSSID = value;
    else if (key == "P") wifiPassword = value;
    else if (key == "H") wifiHidden = (value == "true");
...
const String deviceId = "BVS_Scanner_55";
const String deviceName = "BVS Scanner  55"; // ✅ AI ENABLED - Contains "AI"
const String deviceNameid = "BVS-Scanner-55";
